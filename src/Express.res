...
module Req = {
  ...
  let wrapBoolOrStringApi = (accessor, req, arg) => {
    let value = req->accessor(arg)
  ...
  let accepts = wrapBoolOrStringApi(accepts)
  let acceptsCharset = wrapBoolOrStringApi(acceptsCharset)
  let acceptsEncodings = wrapBoolOrStringApi(acceptsEncodings)
  let acceptsLanguages = wrapBoolOrStringApi(acceptsLanguages)

  @send external get: (req, string) => option<string> = "get"
  @send external is: (req, string) => 'a = "is"

  let is = wrapBoolOrStringApi(is)
